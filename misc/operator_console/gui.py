...
tote_on  = ImageTk.PhotoImage(scale(Image.open("tote_on.png" ), size))
tote_off = ImageTk.PhotoImage(scale(Image.open("tote_off.png"), size))
can_on   = ImageTk.PhotoImage(scale(Image.open("can_on.png"  ), size))
can_off  = ImageTk.PhotoImage(scale(Image.open("can_off.png" ), size))
